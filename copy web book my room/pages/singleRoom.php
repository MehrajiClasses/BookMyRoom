          ...
          <div class="content grid2 mtop">
            <div class="box flex">
              ...
              <div class="right">
                ...
                <h5> <i class="fas fa-dollar-sign"></i>  From 499/night</h5>
                <div class="button">
            ...
            <div class="box flex">
              <div class="left">
                <img src="../images/o2.jpg" alt="image">
              </div>
              <div class="right">
                <h4>Single bed room</h4>
                <div class="rate flex">
            ...
            <div class="box flex">
              ...
              <div class="right">
                ...
                <p><i class="fas fa-map-marker-alt">  near Polytechnic college ,Dhrma food & Restaurant</i>  <i class="fas fa-water">  24/7 water facility available</i>   <i class="fas fa-desktop">  No free wi-fi facility available</i> 
                    <i class="fas fa-phone">   +91 7689543902</i> <i class="fas fa-mug-hot"> No Food facility available  </i></p>
                <h5> <i class="fas fa-dollar-sign"></i>  From 599/night</h5>
                <div class="button">
                  <a href="bookSingleRoom.php"><button>
                    <span>Book Now</span>
                  <i class="fas fa-arrow-circle-right"></i>
            ...
            <div class="box flex">
              ...
              <div class="right">
                ...
                <h5> <i class="fas fa-dollar-sign"></i>  From 799/night</h5>
                <div class="button">
                  <a href="bookSingleRoom.php"><button>
                    <span>Book Now</span>
                  <i class="fas fa-arrow-circle-right"></i>
    ...
    <div class="content grid2 mtop">
      ...
      <div class="box flex">
        ...
        <div class="right">
          ...
          <p><i class="fas fa-map-marker-alt">  Gauchar Dwarahat</i> <i class="fas fa-water">  24/7 water facility available</i>  <i class="fas fa-desktop">  No free wi-fi facility available</i>  
      ...
      <div class="content grid2 mtop">
        <div class="box flex">
          ...
          <div class="right">
            ...
            <p><i class="fas fa-map-marker-alt">  near to the Dwarahat district Hospital</i> <i class="fas fa-water">  24/7 water facility available</i>   <i class="fas fa-desktop">  free wi-fi facility available</i>   
                <i class="fas fa-phone">   +91 9876043902</i> <i class="fas fa-mug-hot"> Food facility available </i></p>
            <h5> <i class="fas fa-dollar-sign"></i>  From 999/night</h5>
            <div class="button">
                  <a href="bookSingleRoom.php"><button>
                    <span>Book Now</span>
        ...
        <div class="box flex">
          ...
          <div class="right">
            ...
            <p><i class="fas fa-map-marker-alt">  Gauchar Dwarahat</i>  <i class="fas fa-water">  24/7 water facility available</i>   <i class="fas fa-desktop">  free wi-fi facility available</i>  
                <i class="fas fa-phone">   +91 9235643902</i> <i class="fas fa-mug-hot"> Food facility available </i></p>
            <h5> <i class="fas fa-dollar-sign"></i>  From 999/night</h5>
              <div class="button">
                  <a href="bookSingleRoom.php"><button>
                    <span>Book Now</span>
        ...
        <div class="box flex">
          ...
          <div class="right">
            ...
            <p><i class="fas fa-map-marker-alt">  near Polytechnic college dwarahat[Almora]</i> <i class="fas fa-water">  24/7 water facility available</i>  <i class="fas fa-desktop">   free wi-fi facility available</i> 
                <i class="fas fa-phone">   +91 7555543902</i><i class="fas fa-mug-hot"> free food facility available breakfast & dinner</i></p>
            <h5> <i class="fas fa-dollar-sign"></i>  From 999/night</h5>
            <div class="button">
                  <a href="bookSingleRoom.php"><button>
                    <span>Book Now</span>
        ...
        <div class="box flex">
          ...
          <div class="right">
           ...
           <h5> We have the Best quality bed for you</h5>
            <h5> <i class="fas fa-dollar-sign"></i>  From 999/night</h5>
              <div class="button">
                  <a href="bookSingleRoom.php"><button>
                    <span>Book Now</span>
